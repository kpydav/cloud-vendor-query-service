...
* The original package name 'com.springboot.compute.cloud-vendor-query-service' is invalid and this project uses 'com.springboot.compute.cloud_vendor_query_service' instead.
